...
public class XTimeUtils {
	...
	static {
		try {
			timeDif = XDateUtil.convertFromString("00:00:00.00", "HH:mm:ss.SS").getTime();
	...
	public static long parseFromTimeStr(String timeStr, String format) throws ParseException {
		Date date = XDateUtil.convertFromString(timeStr, format);
	...
	public static void main(String[] args) throws Exception {
		System.out.println(XDateUtil.convertFromString("00:00:00.111", "HH:mm:ss.SSS").getTime());
		System.out.println(XDateUtil.convertFromString("00:00:00.11", "H:m:s.S").getTime());
		System.out.println(XDateUtil.convertFromString("00:00:10.11", "HH:mm:ss.SS").getTime());
		System.out.println(XDateUtil.convertFromString("00:00:10.111", "HH:mm:ss.SSS").getTime());
		System.out.println(XDateUtil.convertFromString("01:00:10.11", "H:m:s.S").getTime());
