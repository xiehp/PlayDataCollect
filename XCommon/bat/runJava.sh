...
APP_LIB2=/usr/local/tomcat/webapps_docker/ROOT/WEB-INF/lib
APP_HOME=/usr/local/tomcat/webapps_docker/ROOT/WEB-INF/lib
...
java -Xms50m -Xmx250m xie.animeshotsite.utils.ResourceCollectUtils
